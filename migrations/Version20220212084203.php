 ...
 */
final class Version20220212084203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE regiment_users CHANGE update_time update_time_users INT NOT NULL');
    }
