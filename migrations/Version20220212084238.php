 ...
 */
final class Version20220212084238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE regiment_users CHANGE update_time_users update_time INT NOT NULL');
    }
