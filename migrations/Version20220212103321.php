 ...
 */
final class Version20220212103321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stats_logs_visit (id INT AUTO_INCREMENT NOT NULL, ip VARCHAR(255) NOT NULL, time VARCHAR(255) NOT NULL, referar VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
