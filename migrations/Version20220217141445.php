 ...
 */
final class Version20220217141445 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stats_logs_visit ADD platform_id INT NOT NULL');
    }
