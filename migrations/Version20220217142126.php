 ...
 */
final class Version20220217142126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stats_logs_visit CHANGE platform_id platform_id INT DEFAULT 0 NOT NULL');
    }
