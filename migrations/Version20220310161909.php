 ...
 */
final class Version20220310161909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ads CHANGE redirect redirect VARCHAR(255) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE ads CHANGE messages messages TEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE redirect redirect INT NOT NULL, CHANGE type type VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
