 ...
 */
final class Version20220314150032 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE regiment_users ADD experience INT NOT NULL');
    }
