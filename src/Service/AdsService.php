...
class AdsService
{
    ...
    public function user(): string
    {
        ...
        if(isset($ads)){
            ...
            return  '<div style="border: solid 1px black; padding: 1px;">' . self::TYPE[$ads->getType()]['title'] . ': <a target="_blank" href="https://regiment.zbara.pro/ads/views/' . $ads->getId() . '">' . $ads->getName() . '</a>  <b style="color: #' . $color[array_rand($color, 1)] .'">' . $ads->getMessages() . '</b></div>';
        }
        return '';
    }
}
